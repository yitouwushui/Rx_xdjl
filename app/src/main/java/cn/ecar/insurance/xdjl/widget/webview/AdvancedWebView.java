package cn.ecar.insurance.xdjl.widget.webview;
...
import cn.ecar.insurance.xdjl.utils.ui.CustomUtils;
...
//                System.out.println("shouldOverrideUrlLoading走了吗????");
//                System.out.println("shouldOverrideUrlLoadingUrl=" + url);
                ...
                try {
                    ...
                    ToastUtils.showToast("打开应用失败，请重试。");
                ...
                .subscribe(new Action1<Boolean>() {
                    ...
                    public void call(Boolean granted) {
                        if (granted) {
                            ...
                            MdDialogUtils.showListViewDialog(mActivity.get(), listView, "请选择", (view, integer) -> {
