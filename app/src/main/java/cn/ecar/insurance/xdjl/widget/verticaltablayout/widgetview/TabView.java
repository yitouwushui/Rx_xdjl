package cn.ecar.insurance.xdjl.widget.verticaltablayout.widgetview;
...
import cn.ecar.insurance.xdjl.widget.verticaltablayout.badgeview.Badge;
...
public abstract class TabView extends FrameLayout implements Checkable {
    ...
    public static class TabBadge {
        ...
        public int getGravityWidthOffset() {
            return mBuilder.gravityWidthOffset;
        }

        public int getGravityHeightOffset() {
            return mBuilder.gravityHeightOffset;
        }
        ...
        public static class Builder {
            ...
            private int gravityWidthOffset;
            private int gravityHeightOffset;
            ...
            public Builder() {
                ...
                gravityWidthOffset = 5;
                gravityHeightOffset = 5;
                exactMode = false;
                showShadow = true;
            }
            ...
            public Builder setGravityWidthOffset(int dpValue) {
                this.gravityWidthOffset = dpValue;
                return this;
            }

            public Builder setGravityHeightOffset(int dpValue) {
                this.gravityHeightOffset = dpValue;
                return this;
            }
        }
    }
