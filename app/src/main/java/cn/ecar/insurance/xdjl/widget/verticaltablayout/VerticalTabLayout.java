package cn.ecar.insurance.xdjl.widget.verticaltablayout;
...
import cn.ecar.insurance.xdjl.widget.verticaltablayout.adapter.TabAdapter;
import cn.ecar.insurance.xdjl.widget.verticaltablayout.badgeview.DisplayUtil;
import cn.ecar.insurance.xdjl.widget.verticaltablayout.util.TabFragmentManager;
import cn.ecar.insurance.xdjl.widget.verticaltablayout.widgetview.QTabView;
import cn.ecar.insurance.xdjl.widget.verticaltablayout.widgetview.TabIndicator;
import cn.ecar.insurance.xdjl.widget.verticaltablayout.widgetview.TabView;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // TODO: 2017/3/9  
        mTabHeight = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_tab_height,0 );
        typedArray.recycle();
    }
