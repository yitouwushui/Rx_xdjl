...
//		deleteFilesByDirectory(context.getFilesDir());
	...
	public static void cleanDatabases() {
		deleteFilesByDirectory(new File("/data/data/"
				+ XdAppContext.app().getContext().getPackageName() + "/databases"));
	}
	...
	public static void cleanSharedPreference() {
		deleteFilesByDirectory(new File("/data/data/"
				+ XdAppContext.app().getContext().getPackageName() + "/shared_prefs"));
	}
	...
	public static void cleanDatabaseByName( String dbName) {
		XdAppContext.app().getContext().deleteDatabase(dbName);
	}
	...
	public static void cleanFiles() {
		deleteFilesByDirectory(XdAppContext.app().getContext().getFilesDir());
	}
	...
	public static void cleanExternalCache() {
		if (Environment.getExternalStorageState().equals(
			...
			deleteFilesByDirectory( XdAppContext.app().getContext().getExternalCacheDir());
		}
	}
